<#
.SYNOPSIS
    PowerShell script to implement STIG ID: WN10-CC-000230
    PowerShell Script to prevent users from overriding SmartScreen filter warnings in Microsoft Edge
...
if ($currentValue -ne $desiredValue) {
    ...
    Write-Output "SmartScreen PreventOverride set to 1: Users cannot ignore SmartScreen warnings in Microsoft Edge."
} else {
    Write-Output "SmartScreen PreventOverride is already correctly set to 1."
}
